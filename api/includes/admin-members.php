...
function admin_member_normalize(array $member): array
{
    ...
    return [
        ...
        'background_check_expires_at' => (string) ($member['background_check_expires_at'] ?? $member['backgroundCheckExpiresAt'] ?? ''),
        'safesport_expires_at' => (string) ($member['safesport_expires_at'] ?? $member['safesportExpiresAt'] ?? ''),
        'default_pay_rate' => isset($member['default_pay_rate']) && $member['default_pay_rate'] !== '' ? (float) $member['default_pay_rate'] : null,
        'evaluation_score' => isset($member['evaluation_score']) && $member['evaluation_score'] !== '' ? (float) $member['evaluation_score'] : null,
        'photo' => $photo,
