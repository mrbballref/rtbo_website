...
define('STRIPE_ASSIGNOR_TRIAL_PRICE_ID', env_value('STRIPE_ASSIGNOR_TRIAL_PRICE_ID'));
define('STRIPE_ASSIGNOR_MONTHLY_PRICE_ID', env_value('STRIPE_ASSIGNOR_MONTHLY_PRICE_ID'));
define('STRIPE_ASSIGNOR_ANNUAL_PRICE_ID', env_value('STRIPE_ASSIGNOR_ANNUAL_PRICE_ID'));
define('STRIPE_ASSIGNOR_CUSTOM_BRANDING_PRICE_ID', env_value('STRIPE_ASSIGNOR_CUSTOM_BRANDING_PRICE_ID'));
define('STRIPE_ASSIGNOR_TRIAL_DAYS', max(0, (int) env_value('STRIPE_ASSIGNOR_TRIAL_DAYS', '14')));
define('STRIPE_REFZONE_FUNDAMENTALS_PRICE_ID', env_value('STRIPE_REFZONE_FUNDAMENTALS_PRICE_ID'));
define('STRIPE_REFZONE_ADVANTAGE_PRICE_ID', env_value('STRIPE_REFZONE_ADVANTAGE_PRICE_ID'));
define('STRIPE_REFZONE_ELITE_PRICE_ID', env_value('STRIPE_REFZONE_ELITE_PRICE_ID'));
...
define('PAYPAL_REFZONE_FUNDAMENTALS_PLAN_ID', env_value('PAYPAL_REFZONE_FUNDAMENTALS_PLAN_ID'));
define('PAYPAL_REFZONE_ADVANTAGE_PLAN_ID', env_value('PAYPAL_REFZONE_ADVANTAGE_PLAN_ID'));
define('PAYPAL_REFZONE_ELITE_PLAN_ID', env_value('PAYPAL_REFZONE_ELITE_PLAN_ID'));
