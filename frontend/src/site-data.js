...
export const sessions = [
  ...
  ['ualr_team_camp_card.png', 'ualr_icon.png', 'Session 3', 'University of Arkansas at Little Rock', 'July 21-22, 2026 • Little Rock, AR', '$225.00']
];
...
export const seoMeta = {
  ...
  'contract-sign': [
    'RTBO Digital Contract Signature | Secure Client Signing',
    'Secure digital signature page for Raising The Bar Officiating Inc. contracts, client acceptance, and countersigned PDF delivery.'
  ],
  contact: [
...
export const aboutDifferenceCards = [
...
export const platformCards = [
  ...
  ['reliable_partnership_icon.png', 'Crew Builder', 'Build 2-person and 3-person crews, designate crew chiefs, add alternates or observers, contact the crew, and review crew history together.'],
