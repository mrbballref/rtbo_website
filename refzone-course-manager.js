(function () {
  ...
  const COURSE_OVERVIEW_THUMBNAILS = {
    nfhs: '/rtbo_website/assets/images/refzone/course-overviews/nfhs.jpg',
    'njcaa-women': '/rtbo_website/assets/images/refzone/course-overviews/njcaa-women.jpg',
    'njcaa-men': '/rtbo_website/assets/images/refzone/course-overviews/njcaa-men.jpg',
    'naia-women': '/rtbo_website/assets/images/refzone/course-overviews/naia-women.jpg',
    'naia-men': '/rtbo_website/assets/images/refzone/course-overviews/naia-men.jpg',
    'ncaa-women': '/rtbo_website/assets/images/refzone/course-overviews/ncaa-women.jpg',
    'ncaa-men': '/rtbo_website/assets/images/refzone/course-overviews/ncaa-men.jpg',
    wnba: '/rtbo_website/assets/images/refzone/course-overviews/wnba.jpg',
    nba: '/rtbo_website/assets/images/refzone/course-overviews/nba.jpg',
    njcaa: '/rtbo_website/assets/images/refzone/course-overviews/njcaa-men.jpg',
    naia: '/rtbo_website/assets/images/refzone/course-overviews/naia-men.jpg',
    ncaa: '/rtbo_website/assets/images/refzone/course-overviews/ncaa-men.jpg',
    pro: '/rtbo_website/assets/images/refzone/course-overviews/nba.jpg'
  };
  const visualOptions = [
    ['lecture', 'Lecture'],
    ['rules', 'Rules / Quiz'],
  ...
  function render(root, state) {
    ...
    root.innerHTML = `
      ...
      <form class="rtbo-education-crud-form" data-refzone-form>
        ...
        <label class="wide"><span>Course Cover</span><input name="cover" value="${escapeHtml(f.cover)}" placeholder="/rtbo_website/assets/images/refzone/course-covers/njcaa-women.svg"></label>
        ...
        <label class="wide"><span>Course Overview Thumbnail</span><input name="overviewThumbnail" value="${escapeHtml(f.overviewThumbnail)}" placeholder="/rtbo_website/assets/images/refzone/course-overviews/nfhs.jpg"></label>
